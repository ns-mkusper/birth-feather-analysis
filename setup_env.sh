...
pip install ultralytics pandas open_clip_torch einops kornia timm mlx_vlm grad-cam ray jupyterlab ipykernel ipywidgets  onnxruntime jupyter-resource-usage opencv-python matplotlib
